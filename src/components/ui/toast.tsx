...
function Toasts({
  ...
  return (
    <Toast.Portal data-slot="toast-portal" {...portalProps}>
      <Toast.Viewport
        className={cn(
          // Nonmodal notifications must not cover a modal's form or actions.
          // Hovering a toast pauses its timer, so an overlapping toast can
          // otherwise block a mobile dialog button indefinitely.
          "fixed z-40 mx-auto flex w-[calc(100%-var(--toast-inset)*2)] max-w-90 [--toast-inset:--spacing(4)] sm:[--toast-inset:--spacing(8)]",
